...
class Cart {
  ...
  removeItem(itemId, trash = false) {
    ...
    let itemIndex = this.findItemIndex(kishopChetu.cartItems, itemId);
    trash =
      !trash && +kishopChetu.cartItems[itemIndex].quantity <= 1 ? true : trash;
    if (typeof itemIndex === "number") {
      if (trash) {
  ...
  setItemIconsAttributes() {
    ...
    [minusIconElement, plusIconElement, cartItemDeleteElement].map(
      (element) => {
  ...
  createItemDivElements() {
    ...
    return {
      cartItemElement,
      cartItemNameElement,
      cartItemPriceElement,
      quantityContainerElement,
      cartItemValueElement,
      itemQuantityValueElement,
    };
  }
  ...
  renderItem(itemDetails) {
    ...
    this.styleItemElements({
      cartItemImgElement,
      quantityContainerElement: divElements.quantityContainerElement,
      cartItemValueElement: divElements.cartItemValueElement,
    });

    this.setItemIconClickEvents(itemDetails.id, iconElements);

    divElements.cartItemValueElement.append(
      iconElements.minusIconElement,
      divElements.itemQuantityValueElement,
      iconElements.plusIconElement
    );
    divElements.quantityContainerElement.append(
      divElements.cartItemValueElement,
      iconElements.cartItemDeleteElement
    );
    divElements.cartItemElement.append(
      divElements.cartItemNameElement,
      cartItemImgElement,
      divElements.cartItemPriceElement,
      divElements.quantityContainerElement
    );
  ...
  async renderCart() {
    document.getElementById("cart-count").innerHTML =
      this.getItems().cartItems.length;
